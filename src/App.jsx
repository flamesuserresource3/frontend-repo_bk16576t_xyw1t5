    ...
    <div className="min-h-screen bg-white text-gray-900 dark:bg-gray-900 dark:text-white selection:bg-indigo-500/20 selection:text-indigo-700 dark:selection:text-indigo-300">
      ...
      <main>
        ...
        <section id="contact" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 p-8">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">Let’s connect</h2>
            <p className="mt-2 max-w-2xl text-gray-700 dark:text-gray-300">Open to opportunities as a Fresher AI Engineer / Machine Learning Specialist.</p>
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="mailto:bchandrashekharr619@gmail.com" className="inline-flex items-center gap-2 rounded-md bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-4 py-2 text-sm font-medium shadow hover:opacity-90 transition">
                Email: bchandrashekharr619@gmail.com
              </a>
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-600 dark:text-gray-400">
          <p>© {new Date().getFullYear()} CHANDRASHEKHAR B. All rights reserved.</p>
          <nav className="flex items-center gap-4">
            ...
            <a href="#experience" className="hover:text-gray-900 dark:hover:text-gray-200">Experience</a>
            <a href="#certifications" className="hover:text-gray-900 dark:hover:text-gray-200">Certifications</a>
